...
func (m *TConfigProjectForm) initMacOSOptions() {
	...
	m.CFBundleNameEdit.SetName("ConfigProjectFormCFBundleNameEdit")
	m.CFBundleNameEdit.EditLabel().SetCaption(metadata.GI18n.Dict("ConfigProjectFormCFBundleNameEdit.EditLabel.Caption"))
	...
	m.CFBundleNameEdit.SetTextHint(metadata.GI18n.Dict("ConfigProjectFormCFBundleNameEdit.TextHint"))
	m.CFBundleNameEdit.SetHint(metadata.GI18n.Dict("ConfigProjectFormCFBundleNameEdit.Hint"))
	...
	m.CFBundleLocalizationsEdit.SetName("ConfigProjectFormCFBundleLocalizationsEdit")
	m.CFBundleLocalizationsEdit.EditLabel().SetCaption(metadata.GI18n.Dict("ConfigProjectFormCFBundleLocalizationsEdit.EditLabel.Caption"))
	...
	m.CFBundleLocalizationsEdit.SetTextHint(metadata.GI18n.Dict("ConfigProjectFormCFBundleLocalizationsEdit.TextHint"))
	m.CFBundleLocalizationsEdit.SetHint(metadata.GI18n.Dict("ConfigProjectFormCFBundleLocalizationsEdit.Hint"))
	...
	m.LSUIElementText.SetName("ConfigProjectFormLSUIElementText")
	m.LSUIElementText.SetLeft(0)
	m.LSUIElementText.SetTop(nextTop(35))
	m.LSUIElementText.SetWidth(100)
	m.LSUIElementText.SetAutoSize(false)
	m.LSUIElementText.SetAlignment(types.TaRightJustify)
	m.LSUIElementText.SetCaption(metadata.GI18n.Dict("ConfigProjectFormLSUIElementText.Caption"))
	m.LSUIElementText.SetParent(m.platformTabPageMacOS)

	m.LSUIElementBox = lcl.NewComboBox(m)
	m.LSUIElementBox.SetName("ConfigProjectFormLSUIElementBox")
	...
	m.LSUIElementBox.AnchorSideTop().SetControl(m.LSUIElementText)
	m.LSUIElementBox.AnchorSideTop().SetSide(types.AsrCenter)
	m.LSUIElementBox.SetHint(metadata.GI18n.Dict("ConfigProjectFormLSUIElementBox.Hint"))
	m.LSUIElementBox.SetParent(m.platformTabPageMacOS)

	m.LSMinimumSystemVersionText = lcl.NewLabel(m)
	m.LSMinimumSystemVersionText.SetName("ConfigProjectFormLSMinimumSystemVersionText")
	m.LSMinimumSystemVersionText.SetLeft(0)
	m.LSMinimumSystemVersionText.SetTop(nextTop(35))
	m.LSMinimumSystemVersionText.SetWidth(100)
	m.LSMinimumSystemVersionText.SetAutoSize(false)
	m.LSMinimumSystemVersionText.SetAlignment(types.TaRightJustify)
	m.LSMinimumSystemVersionText.SetCaption(metadata.GI18n.Dict("ConfigProjectFormLSMinimumSystemVersionText.Caption"))
	m.LSMinimumSystemVersionText.SetParent(m.platformTabPageMacOS)

	m.LSMinimumSystemVersionBox = lcl.NewComboBox(m)
	m.LSMinimumSystemVersionBox.SetName("ConfigProjectFormLSMinimumSystemVersionBox")
	...
	m.LSMinimumSystemVersionBox.AnchorSideTop().SetControl(m.LSMinimumSystemVersionText)
	m.LSMinimumSystemVersionBox.AnchorSideTop().SetSide(types.AsrCenter)
	m.LSMinimumSystemVersionBox.SetHint(metadata.GI18n.Dict("ConfigProjectFormLSMinimumSystemVersionBox.Hint"))
