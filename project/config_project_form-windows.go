...
func (m *TConfigProjectForm) initWindowsOptions() {
	...
	m.appNameEdit.SetBounds(45, windowsBaseTop-5, 200, 30)
	...
	m.appDescEdit.SetBounds(m.appDescText.Left()+35, windowsBaseTop-5, 200, 30)
	...
	m.appVersionEdit.SetBounds(m.appVersionText.Left()+35, windowsBaseTop+40, 200, 30)
	...
	m.compatibilityOSBox.SetBounds(m.compatibilityOSText.Left()+35, windowsBaseTop+40, 200, 30)
	...
	m.dpiBox.SetBounds(m.dpiText.Left()+35, windowsBaseTop+85, 180, 30)
	...
	m.runLevelBox.SetBounds(m.runLevelText.Left()+60, windowsBaseTop+85, 200, 30)
